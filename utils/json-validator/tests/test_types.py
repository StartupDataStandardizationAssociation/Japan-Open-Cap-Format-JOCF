...
class TestSchemaId:
    ...
    def test_create_schema_id(self):
        ...
        schema_id = SchemaId("https://jocf.startupstandard.org/jocf/main/schema/objects/StockClass.schema.json")
    ...
    def test_schema_id_equality(self):
        """SchemaIdの等価性をテスト"""
        schema_id1 = SchemaId("https://jocf.startupstandard.org/jocf/main/schema/objects/StockClass.schema.json")
        schema_id2 = SchemaId("https://jocf.startupstandard.org/jocf/main/schema/objects/StockClass.schema.json")
        schema_id3 = SchemaId("https://jocf.startupstandard.org/jocf/main/schema/objects/Transaction.schema.json")
