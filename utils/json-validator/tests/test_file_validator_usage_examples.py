...
class TestFileValidatorUsageExamples(unittest.TestCase):
    ...
    def test_handle_common_validation_errors(self):
        ...
        # ケース1: file_type不正
        invalid_file_type_data = {"file_type": "INVALID_FILE_TYPE", "items": []}
        ...
        invalid_object_type_data = {
            "file_type": "JOCF_TRANSACTIONS_FILE",
            "items": [{"object_type": "INVALID_OBJECT_TYPE", "id": "test-item"}],
        }
    ...
    def test_error_message_analysis_pattern(self):
        ...
        complex_error_data = {
            ...
            "items": [
                ...
                {"object_type": "TYPO_OBJECT_TYPE", "id": "invalid-object-type-item"},
            ],
        }
    ...
    def test_batch_file_validation_pattern(self):
        ...
        self.assertEqual(
            len(validation_results), len(jocf_files), "全ファイルの検証結果があるべき"
        )
    ...
    def test_practical_development_workflow(self):
        ...
        # CI/CD向けの結果判定例
        ci_cd_success = (
            detailed_report["is_valid"] or detailed_report["error_count"] == 0
        )
