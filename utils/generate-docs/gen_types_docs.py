...
import os
import glob
from schema_to_md.types_schema_to_md import generate

def main():
    # schema/types/配下の全ての.schema.jsonファイルを取得（サブディレクトリ含む）
    schema_dir = os.path.join(os.path.dirname(__file__), '../../schema/types')
    schema_files = []
