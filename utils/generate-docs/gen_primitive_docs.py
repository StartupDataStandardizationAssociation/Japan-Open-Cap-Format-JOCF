...
import os
import glob
from schema_to_md.primitive_schema_to_md import generate

def main():
    # schema/primitives配下の全ての.schema.jsonファイルを取得（サブディレクトリ含む）
    schema_dir = os.path.join(os.path.dirname(__file__), '../../schema/primitives')
    schema_files = []
